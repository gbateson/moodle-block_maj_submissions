...
$string['collectpresentationscmid_help'] = 'The database activity that is used to collect presentation submissions.';
$string['collectpresentationscmid'] = 'Presentation proposals';
$string['collectpresentationstime_help'] = 'The dates and times at which the online collection of presentation submissions starts and finshes.';
$string['collectpresentationstime'] = 'Call for presentation proposals';
$string['collectsponsoredscmid_help'] = 'The database activity that is used to collect sponsored presentation submissions.';
$string['collectsponsoredscmid'] = 'Sponsored proposals';
$string['collectsponsoredstime_help'] = 'The dates and times at which the online collection of sponsored submissions starts and finshes.';
$string['collectsponsoredstime'] = 'Call for sponsored proposals';
$string['collectsubmissions'] = 'Submit proposals';
$string['collectworkshopscmid_help'] = 'The database activity that is used to collect workshop submissions.';
$string['collectworkshopscmid'] = 'Workshop proposals';
$string['collectworkshopstime_help'] = 'The dates and times at which the online collection of workshop submissions starts and finshes.';
...
$string['conferencedates_help'] = 'The conference start and end dates, as a text string, that appear on the documents for this conference.';
$string['conferencedates'] = 'Conference dates';
$string['conferenceevents'] = 'Conference events';
$string['conferencename_help'] = 'The conference name that appears on the documents for this conference.';
$string['conferencename'] = 'Conference name';
$string['conferencestrings_help'] = 'These strings and values are used in the databases and documents for registration, presentations, and workshops.';
...
$string['conferencevenue_help'] = 'The conference venue name that appears on the documents for this conference.';
...
$string['dinnerdate_help'] = 'The conference dinner date, as a text string, that appears on the documents for this conference.';
$string['dinnerdate'] = 'Dinner date';
$string['dinnername_help'] = 'The conference dinner name that appears on the documents for this conference.';
...
$string['dinnertime_help'] = 'The conference dinner start and end times, as a string, that appear on the documents for this conference.';
$string['dinnertime'] = 'Dinner time';
$string['dinnervenue_help'] = 'The conference dinner venue name that appears on the documents for this conference.';
