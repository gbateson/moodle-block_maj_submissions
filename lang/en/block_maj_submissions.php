...
$string['publishcmid_help'] = 'The database activity where submissions are published.';
...
$string['registercmid'] = 'Registration activity';
$string['registerparticipation'] = 'Register participation';
$string['registertimefinish_help'] = 'The time and date at which online registration for attending the conference finishes.';
$string['registertimefinish'] = 'Registration finish';
$string['registertimestart_help'] = 'The time and date at which online registration for attending the conference starts.';
$string['registertimestart'] = 'Registration start';
...
$string['reviewsectionnum_help'] = 'The section of the course where the review activities can be found.';
