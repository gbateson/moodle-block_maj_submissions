...
$string['conferenceeventscmid_help'] = 'Select the database of conference events, such as registration and food breaks, that can be added to the schedule.';
$string['conferenceeventscmid'] = 'Conference events database';
$string['conferenceeventsname'] = 'Add conference events';
