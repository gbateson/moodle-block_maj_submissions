...
/**
 * blocks/maj_submissions/tools/reviewersforum/tool.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/maj_submissions/tools/reviewersforum/form.php');

$blockname = 'maj_submissions';
$plugin = "block_$blockname";
$tool = 'toolreviewersforum';
...
$mform = 'block_maj_submissions_tool_reviewersforum';
