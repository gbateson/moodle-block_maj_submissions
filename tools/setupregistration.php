...
/**
 * blocks/maj_submissions/tools/setupregistration.php
 *
 * @package    blocks
...
$pagetitle = get_string('toolsetupregistration', $plugin);
...
echo html_writer::tag('p', get_string('toolsetupregistration_desc', $plugin));
