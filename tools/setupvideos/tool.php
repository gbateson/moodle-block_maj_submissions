...
/**
 * blocks/maj_submissions/tools/setupvideos/tool.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/maj_submissions/tools/setupvideos/form.php');

$blockname = 'maj_submissions';
$plugin = "block_$blockname";
$tool = 'toolsetupvideos';
...
$mform = 'block_maj_submissions_tool_setupvideos';
