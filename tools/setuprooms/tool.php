...
/**
 * blocks/maj_submissions/tools/setuprooms/tool.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/maj_submissions/tools/setuprooms/form.php');
...
$mform = 'block_maj_submissions_tool_setuprooms';
