...
class block_maj_submissions_tool_setuprooms extends block_maj_submissions_tool_setupdatabase {
    protected $type = 'registerrooms';
    protected $defaultpreset = 'rooms';
    protected $defaultname = 'conferencerooms';
