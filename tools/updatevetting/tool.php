...
/**
 * blocks/maj_submissions/tools/updatevetting/tool.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/maj_submissions/tools/updatevetting/form.php');

$blockname = 'maj_submissions';
$plugin = "block_$blockname";
$tool = 'toolupdatevetting';
...
$mform = 'block_maj_submissions_tool_updatevetting';
