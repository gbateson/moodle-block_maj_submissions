...
/**
 * blocks/maj_submissions/tools/authorsgroup/tool.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/maj_submissions/tools/authorsgroup/form.php');

$blockname = 'maj_submissions';
$plugin = "block_$blockname";
$tool = 'toolauthorsgroup';
...
$mform = 'block_maj_submissions_tool_authorsgroup';
