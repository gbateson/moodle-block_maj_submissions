...
/**
 * blocks/maj_submissions/tools/setupvetting/tool.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/maj_submissions/tools/setupvetting/form.php');

$blockname = 'maj_submissions';
$plugin = "block_$blockname";
$tool = 'toolsetupvetting';
...
$mform = 'block_maj_submissions_tool_setupvetting';
