...
/**
 * blocks/maj_submissions/tools/workshop2assign.php
 *
 * @package    blocks
...
$pagetitle = get_string('toolworkshop2assign', $plugin);
...
echo html_writer::tag('p', get_string('toolworkshop2assign_desc', $plugin));
